  ...
  grunt.initConfig({
    ...
    env: {
      ...
      local: {
        ...
        "FH_PORT": 8001,
        "BPM_PUSH_NOTIFICATIONS_APP": "mpas6ioe2qde7uhelfqnndxp" ,
        "BPM_USE_DUMMY_DATA": true,
        "BPM_AUTHORISATION":  "Basic a2llc2VydmVyOnBhc3N3b3JkMSE=",
        "BPM_USE_DUMMY_DATA": "true",
        "BPM_HOST_LOCAL": "http://localhost:8080", // local
        "BPM_CONTAINER_LOCAL":  "ApplicationManagement-1.7", // local
        "BPM_PROCESS_LOCAL":  "Application-Management.NewApplication1", // local
        "BPM_HOST": "http://new-application-bpms-demo.int.n.paas.redhat.com",
        "BPM_CONTAINER":  "abca02da35dc8f2e6a54ccdf40609f22", //remote
        "BPM_PROCESS":  "com.rh.demo.bpm.NewApplication", // remote
